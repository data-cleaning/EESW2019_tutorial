...
\logo{
  ...
  \begin{tikzpicture}[remember picture, overlay]
    \node[xshift=10mm,yshift=3mm] at (current page.south west) {
        \includegraphics[height=5mm]{../00tex/eesw.png}
    };
  \end{tikzpicture}
}
...
Twitter: \texttt{@markvdloo} \texttt{@edwindjonge}}
